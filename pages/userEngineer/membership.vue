        ...
        <div class="flex gap-2">
            ...
            <div class="rounded-[24px] w-[80%] shadow-lg bg-red-100 mb-12  p-3">
                ...
                <ul class="text-[#262626] ">
                    <li class="text-[16px]">• You <span class="font-semibold">cannot display your projects</span> until you subscribe.</li>
                    <li class="text-[16px]">• After your membership expires, <span class="font-semibold">clients will not be able to contact
                            you directly</span>.</li>
                    <li class="text-[16px]">• You can edit, add, or remove your projects anytime during your active subscription.</li>
                </ul>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-14  mx-auto">
                <div @click="openModal('Monthly', 1, 500)"
                    ...
                    <button
                        class="px-5 py-2 bg-[#C76950] text-white rounded-xl shadow cursor-pointer transition">Subscribe
                        Monthly</button>
                </div>
  ...
  <div class="bg-white rounded-2xl shadow-xl w-[450px] p-5 relative">
    ...
    <div class="space-y-3">
      <div>
        ...
        <Input 
          type="text"
          class="border rounded-lg w-full p-2 mt-1 text-sm outline-none"
    ...
    <button
      ...
      class="w-full mt-5 bg-[#C76950] text-white text-[15px] font-semibold py-2 rounded-lg
