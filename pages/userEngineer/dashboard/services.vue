    ...
    <EngineerSideBar>
        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <div v-if="showModal"
             ...
             flex items-center justify-center shadow">✕</button>
                    <div  class="flex flex-col gap-5">
                        <label class="font-bold w-full text-m text-[#3E3E3E]"> Title</label>
                        <input type="text" v-model="newService.title"
                            class="font-semibold w-full text-sm text-[#3E3E3E] shadow-[0px_4px_12px_rgba(0,0,0,0.08)] border rounded-[24px] p-3 outline-none h-[50px]"
                            placeholder="e.g. Home Renovation" />
                        <label class="font-bold text-m text-[#3E3E3E]"> Description</label>
                        <input type="text" v-model="newService.description"
                            class="font-semibold text-sm text-[#3E3E3E] shadow-[0px_4px_12px_rgba(0,0,0,0.08)] border rounded-[24px] p-3 outline-none h-[50px]"
            ...
            <div v-if="services.length > 0" class="w-[600px] mt-10 ml-12">
                <table class="table-auto p-5 w-full border-collapse rounded-[12px] overflow-hidden shadow-lg text-center">
